      ...
      <div className="max-w-md w-full space-y-8 animate-submit-view">
        ...
        <div className="space-y-3">
          ...
          <p className="text-slate-500 leading-relaxed">
            Your responses have been securely uploaded. You have successfully
            completed the certification attempt.
          </p>
        </div>
        <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100 space-y-4 shadow-sm">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            The evaluation process has started. Your results will be released
            via your registered dashboard soon.
          </p>
        </div>
        <button
