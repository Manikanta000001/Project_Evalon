...
const ExamPaper = ({ data: paperData }) => {
  ...
  return (
    <div className="bg-white text-black font-serif">
      ...
      <div
        id="printable-paper"
        className=" mx-auto bg-white shadow-2xl p-8 md:p-12 print:shadow-none print:p-0"
        style={{
          width: "210mm",
          minHeight: "297mm",
        }}
        ...
        <div className="border-[1.5px] border-black p-0 overflow-hidden">
          ...
          <div className="flex border-b border-black text-[10px] font-bold">
            ...
            <div className="w-32 border-l border-black p-1 text-center bg-gray-50 print:bg-white">
              Regulation:
              <div className="text-sm font-black mt-1 uppercase font-sans">
                {paperData.regulation}
              </div>
            </div>
          </div>
          ...
          <div className="border-b border-black text-center py-3 bg-gray-50 print:bg-white relative">
            ...
            <h3 className="text-[13px] font-bold mt-1 underline decoration-black underline-offset-4 font-sans">
              {paperData.examType}
            </h3>
            <p className="text-[11px] font-black mt-2 tracking-wide text-gray-700">
              {paperData.branch}
            </p>

            {/* Common To (Only if exists) */}
            {paperData.commonTo && paperData.commonTo.length > 0 && (
              <p className="text-[10px] mt-1 text-gray-600 font-sans tracking-normal">
                [ Common to {formatDepartments(paperData.commonTo)} ]
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 text-xs font-bold divide-x divide-black border-b border-black">
            <div className="p-2 space-y-1">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-sans">{paperData.dateSession}</span>
              </div>
            </div>
            <div className="p-2 space-y-1">
              <div className="flex justify-between">
                ...
                <span className="font-sans">{paperData.maxMarks}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 uppercase text-[9px]">
                  Time Duration:
                </span>
                <span className="font-sans">{paperData.time}</span>
              </div>
            </div>
          </div>
        ...
        <table className="w-full mt-6 border-collapse border border-black text-[13px]">
          <thead className="bg-gray-100 print:bg-transparent">
            <tr className="border-b border-black">
              ...
              <th className="border-r border-black w-10 py-1 text-[10px]">
                CO
              </th>
              <th className="border-r border-black w-10 py-1 text-[10px]">
                BL
